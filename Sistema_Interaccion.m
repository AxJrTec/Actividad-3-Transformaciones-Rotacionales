...
syms th1(t) th2(t) th3(t) th4(t) th5(t) th6(t) t d1 d2 d3 d4 d5
...
%Junta 2
P(:,:,2)= [-d2*sin(th2); d2*cos(th2); 0];
R(:,:,2)= [cos(th2) -sin(th2)  0;
           sin(th2)  cos(th2)  0;
           0         0         1];

%Junta 3
P(:,:,3) = [-d3*sin(th3); d3*cos(th3); 0];
